...
public class EmojisPopup extends PopupWindow implements ViewPager.OnPageChangeListener, EmojiRecents {
    EmojiGridView.OnEmojiClickedListener onEmojiClickedListener;
    View view;
     ...
     */
    public EmojisPopup(View rootView, Context mContext, boolean useSystemDefault, String iconPressedColor, String tabsColor, String backgroundColor) {
        super(mContext);
        this.setColor = true;
     ...
     * @param useSystemDefault .
     */
    public EmojisPopup(View rootView, Context mContext, boolean useSystemDefault) {
        super(mContext);
        this.mUseSystemDefault = useSystemDefault;
        this.mContext = mContext;
        this.rootView = rootView;
    ...
    public void dismiss() {
        super.dismiss();
        EmojiRecentsManager
                .getInstance(mContext).saveRecentEmojis();
    }
    ...
    private View createCustomView() {
        ...
        mEmojisAdapter = new EmojisPagerAdapter(
                Arrays.asList(
                        new EmojiRecentsGridView(mContext, null, null, this, mUseSystemDefault),
                        new EmojiGridView(mContext, EmojiManager.INSTANCE.getPeopleEmojis(), recents, this, mUseSystemDefault),
                        new EmojiGridView(mContext, EmojiManager.INSTANCE.getNatureEmojis(), recents, this, mUseSystemDefault),
                        new EmojiGridView(mContext, EmojiManager.INSTANCE.getFoodEmojis(), recents, this, mUseSystemDefault),
                        new EmojiGridView(mContext, EmojiManager.INSTANCE.getSportEmojis(), recents, this, mUseSystemDefault),
                        new EmojiGridView(mContext, EmojiManager.INSTANCE.getCarEmojis(), recents, this, mUseSystemDefault),
                        new EmojiGridView(mContext, EmojiManager.INSTANCE.getObjectsEmojis(), recents, this, mUseSystemDefault),
                        new EmojiGridView(mContext, EmojiManager.INSTANCE.getSymbolEmojis(), recents, this, mUseSystemDefault),
                        new EmojiGridView(mContext, EmojiManager.INSTANCE.getFlagsEmojis(), recents, this, mUseSystemDefault)
                )
        );
    ...
    public void addRecentEmoji(Context context, Emoji emoji) {
        ...
        fragment.addRecentEmoji(context, emoji);
    }
