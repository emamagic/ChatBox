...
class ChatBoxPicker : BottomSheetDialogFragment() {
    ...
    private fun updateAdapter() {
        imageGalleryAdapter = ImageGalleryAdapter(requireContext(), builder)
    ...
    class Builder(
        ...
        var cameraTileDrawable: Drawable? = ContextCompat.getDrawable(context,
            R.drawable.ic_camera_picker
        ),
        var galleryTileDrawable: Drawable? = ContextCompat.getDrawable(context,
            R.drawable.ic_gallery_picker
        ),
        ...
        fun create(context: Context): ChatBoxPicker {
            ...
            val customBottomSheetDialogFragment = ChatBoxPicker()
