    ...
    public static class PermissionsBuilder {
        ...
        public void execute(int requestCode) {
            ...
            if (ifNecesary && (permissionObject.hasAll(requestedPermissions) || !condition)) {
                ...
                executePermissionsRequest(requestCode, request);
            }
        }
...
//                    .setLayout((int) (permissionObject.getWindowWidth() * .75), ViewGroup.LayoutParams.WRAP_CONTENT);
        ...
        private void executePermissionsRequest(int requestCode, PermissionsRequest request) {
            synchronized (OUTSTANDING) {
    ...
    private abstract static class PermissionObject {
        ...
        int getWindowWidth() {
            WindowManager windowManager = ServiceHelper.getWindowManager(getContext());
